 ...
 * @author franc
 */
public class AnimalTela8 extends javax.swing.JFrame {
    ...
    public AnimalTela8() {
        ...
        msg_txt.setText("<html>Seu personagem é <strong>adulto (a)</strong>?</html>");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seu personagem são: ");

        imagem.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        imagem.setForeground(new java.awt.Color(0, 0, 0));
        imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/Toquinho e lasquita.jpg"))); // NOI18N
    ...
    private void botao_naoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_naoActionPerformed
        if (verificacao) {
            ...
            txt_resposta.setText("Toquinho e Lasquita");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalTela8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimalTela8().setVisible(true);
            }
        });
    }
