 ...
 * @author franc
 */
public class AnimalTela9 extends javax.swing.JFrame {
    ...
    public AnimalTela9() {
        ...
        msg_txt.setText("<html>Seu personagem é <strong>masculino</strong>?</html>");
    }
    ...
    private void initComponents() {
        ...
        imagem.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        imagem.setForeground(new java.awt.Color(0, 0, 0));
        imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/Paulina.png"))); // NOI18N
        ...
        getContentPane().add(painel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 221, 412, 110));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalTela9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimalTela9().setVisible(true);
            }
        });
    }
