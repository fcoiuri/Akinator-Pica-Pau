 ...
 * @author franc
 */
public class PicaPau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_resposta.setText("Seu personagem é ele que dispensa apresentações  ");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/picapaugif.gif"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText("O Pica-Pau");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PicaPau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
