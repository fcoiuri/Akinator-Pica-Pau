 ...
 * @author franc
 */
public class AnimalTela6 extends javax.swing.JFrame {
    ...
    public AnimalTela6() {
        ...
        msg_txt.setText("<html>Seu personagem é um <strong>animal de estimação</strong> de algum personagem?</html>");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(botao_nao, new org.netbeans.lib.awtextra.AbsoluteConstraints(126, 136, 70, 30));
        ...
        getContentPane().add(painel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 231, 428, 100));
...
double aleatorio = Math.random() * 2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalTela6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
