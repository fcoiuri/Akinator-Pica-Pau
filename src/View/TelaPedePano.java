 ...
 * @author franc
 */
public class TelaPedePano extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_resposta.setText("Seu personagem é o fiel PÉ DE PANO ");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/pé de pano.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPedePano.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
