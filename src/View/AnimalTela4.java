 ...
 * @author franc
 */
public class AnimalTela4 extends javax.swing.JFrame {
    ...
    public AnimalTela4() {
        ...
        msg_txt.setText("<html>Seu personagem é <strong>um urubu</strong>?</html>");
    }
    ...
    private void botao_simActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_simActionPerformed
        new TelaZecaUrubu().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalTela4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
